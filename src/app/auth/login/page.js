...
export default function LoginPage() {
  return (
    <div className='container flex relative h-[100vh] flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0'>
      ...
      <div className='lg:p-8'>
        <div className='mx-auto flex w-full flex-col justify-center item-center space-y-6 sm:w-[350px]'>
